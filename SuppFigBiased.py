...
W = (mu+sigma*torch.randn(N,N).to(device))/np.sqrt(N)

# Basis for column and row space of low rank part
...
if SaveFigs:
    fig.savefig('./Figures/SuppFigBias.pdf')
    fig.savefig('./Figures/SuppFigBiasunpolished.svg')
